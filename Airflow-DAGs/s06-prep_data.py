...
dag = DAG(
    ...
    params={
        ...
        "s3_bucket": Param(
            "seat06", type="string", description="S3 bucket to pull binary data from"
        ),
        "s3_path": Param(
            "data/mnist",
            type="string",
    ...
    access_control={"Admin": {"can_read"},"Admin.student1032.06-hpelabsonline.com":{"can_read","can_edit","can_delete"}},
)
