...
dag = DAG(
    ...
    params={
        ...
        "s3_bucket": Param(
            "seat09", type="string", description="S3 bucket to pull binary data from"
        ),
        "s3_path": Param(
            "data/mnist",
            type="string",
    ...
    access_control={"student1032.09-hpelabsonline.com": {"can_read"},"student1032.09-hpelabsonline.com":{"can_read","can_edit","can_delete"}},
)
